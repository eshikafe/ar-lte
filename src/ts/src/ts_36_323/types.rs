...
struct PdcpEntity {
    ...
    config: rrc::PdcpConfig,
    /// the PDCP SN of the next PDCP SDU for a given PDCP entity
    next_pdcp_tx_sn: u32,
    ///the HFN value for the generation of the COUNT value used for PDCP PDUs for agiven PDCP entity
    tx_hfn: u32, 
    next_pdcp_rx_sn: u32,
    rx_hfn: u32,
